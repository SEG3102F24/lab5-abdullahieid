...
import {collection, collectionGroup, getDocs, getFirestore} from "@angular/fire/firestore";
...
export class AddressListComponent implements OnInit {
  ...
  getetet() {
    const hm: AddressEntry[]  = []
    console.log("doin")
    getDocs(collectionGroup(getFirestore(), 'addresses'))
      .then((i) => {console.log(i.docs.forEach(
        i => {
          hm.push(<AddressEntry>i.data())
        }
      ))});
